    ...
    <div className="w-full">
      <div className="w-screen h-[30vh] lg:h-[40vh] relative">
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2">
          <h2 py-2>Amazon Clone</h2>
          <h3>Next.js / Redux / MongoDB</h3>
        </div>
      </div>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <a href="https://webheads-primo-w6n8.onrender.com" target="_blank">
        ...
        <div className="col-span-4 md:col-span-1 shadow-xl shadow-gray-100 rounded-xl p-4">
          <div className="p-2">
            ...
            <div className="grid grid-cols-3 md:grid-cols-1">
              ...
              <p className="text-gray-600 py-2 flex items-center">
                <RxGear className="pr-1" /> MongoDB
              </p>
              <p className="text-gray-600 py-2 flex items-center">
                <RxGear className="pr-1" /> Mongoose
              </p>
              <p className="text-gray-600 py-2 flex items-center">
                <RxGear className="pr-1" /> Bootstrap
              </p>
              <p className="text-gray-600 py-2 flex items-center">
                <RxGear className="pr-1" /> Express
              </p>
            </div>
          </div>
        </div>
