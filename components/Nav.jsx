    ...
    <div className="flex justify-between items-center w-full h-full px-2xl:px-16">
        ...
        <div>
          <ul className="hidden md:flex">
            ...
            <Link href='/'>
              <li className="ml-10 text-sm uppercase hover:border-b">Content</li>
            </Link>
          </ul>
        ...
        <div className={nav ? "md:hidden fixed left-0 top-0 w-full h-screen bg-black/40" : ''}>
          ...
          : 
          "fixed left-[-200%] p-10 ease-in duration-300"
          }
          >
            <div>
              <div className="flex w-full items-center justify-between">
                <Image src="/../public/assets/jw-logo.png" width='50' height='50' alt="navLogo" />
                <div onClick={handleNav} className="rounded-full shadow-lg shadow-gray-400 p-3 cursor-pointer">
                  <AiOutlineClose />
                </div>
              </div>
              <div className="border-b border-gray-300 my-4">
                <p className="w-[85%] md:w-[90%] py-4">Catchy line to go here later when I'm less dumb</p>
              </div>
            </div>
            <div className="py-4 flex flex-col">
              ...
              <div className="pt-40">
                <p className="uppercase tracking-widest text-[#5b7379]">
                  Let's Connect
                </p>
